INSERT INTO sponsor (id, name) VALUES (1, 'Seneca Park Zoo');
...
INSERT INTO asset (project_id, asset_type_id, location)
	SELECT 1, 1, ST_MakePoint(-19 + ((random() - 0.5) * 4), 46 + ((random() - 0.5) * 4))
	FROM generate_series(1, 10);

INSERT INTO asset (project_id, asset_type_id, location)
	SELECT 2, 2, ST_MakePoint(-19.8 + ((random() - 0.5) * 4), 46 + ((random() - 0.5) * 4))
	FROM generate_series(1, 10);
